...
\begin{itemize}
\item Règles d'expression d'un élément: \texttt{<element/>}, \texttt{<element>contenu</element>}
\item Règle d'expression des attributs: espaces et guillemets obligatoires
\end{itemize}
\end{enumerate}
\item \textbf{En XML} ($\neq$ TEI), il n'y a pas de règle quant au nom des éléments (d'où \enquote{eXtensible})
\end{itemize}
\end{frame}
...
\subsubsection{Corriger un XML mal structuré}
...
La touche \texttt{ACTION} correspond à CTRL sur Windows/Linux et POMME sur Mac.
\begin{itemize}
...
\item Créer un élément parent autour d'un ensemble de noeuds textuels ou éléments: \texttt{ACTION + E}
\end{itemize}
\end{frame}
...
\begin{center}
\begin{figure}
\includegraphics[width=.7\textwidth, trim={0 12cm 0 0}, clip]{../../img/proust.png}
\caption{L'édition des brouillons de Proust \parencite{andreCodageTEIBrouillons2013}}
\end{figure}
\end{center}
\end{frame}
...
\begin{center}
\begin{figure}
\includegraphics[width=.7\textwidth]{../../img/resultats.png}
\caption{Un exemple d'édition critique numérique \parencite{gillelevensonRegimientoPrincipesSa2023}}
\end{figure}
\end{center}
\end{frame}
...
\begin{figure}
\begin{minted}[breaklines,numbersep=2mm]{python}
for rdg in apps:
    if rdg.is_empty() and following_rdg.is_empty():
            create_node(witEnd)
\end{minted}
\caption{Pseudo-code décrivant l'insertion automatisée de balises de lacunes textuelles}
\end{figure}
\end{frame}

\begin{frame}{L'alignement multilingue de sources vernaculaires médiévales}
\begin{figure}[ht!]
\centering
\begin{subfigure}{.6\textwidth}
  \centering
\includegraphics[width=.9\textwidth, trim={0cm 0cm 0 0cm}]{../../img/xml_lat.png}
\end{subfigure}%
\begin{subfigure}{.4\textwidth}
  \centering
\includegraphics[width=.8\textwidth]{../../img/xml_spo.png}
\end{subfigure}
\end{figure}
\end{frame}
...
\begin{frame}{}
\begin{itemize}
\item L'incipit de la \textit{Recherche du temps perdu} de Proust
