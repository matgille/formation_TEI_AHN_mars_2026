...
\title[Le XML]{Session 1: Introduction générale au XML et à la TEI\\ {\small Atelier Humanités Numériques \\ Lyon}}
...
\subsection{Application avec Oxygen}
...
\begin{frame}{Raccourcis clavier}
...
\item Décrire cette essence en tant selon un \textbf{consensus scientifique}
\end{itemize}
\begin{center}
\begin{figure}
...
\begin{itemize}
\item Un sonnet
\item Une scène de \textit{Juste la fin du monde} de Jean-Luc Lagarce (1994)
\end{itemize}
\end{frame}
