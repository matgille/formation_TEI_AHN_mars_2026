...
\begin{frame}{Conformité n'est pas validité}
\begin{itemize}
\item Un document conforme n'est pas forcément valide:
\item Un document XML peut être bien formé, mais ne pas respecter les règles d'un \textbf{schéma}
\end{itemize}
\end{frame}
...
\item Appliqué à un codage de texte, un schéma est un \textbf{modèle} du \enquote{texte}, c'est-à-dire une \textbf{représentation formelle} du texte.
