...
\item Ne réinventez pas la roue ! Et utilisez 
\end{enumerate}
\end{frame}
...
\section{Modules fondamentaux}

\subsection{Les metadonnées}
\begin{frame}{Décrire un document XML-TEI: le \texttt{teiHeader}}
\begin{itemize}
